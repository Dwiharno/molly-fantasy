...
$(function () {
    ...
    const columnDefs = {
        redeem_pos: [
            ...
            { data: 'qty', title: 'Qty Item', className: 'text-center' },
            { data: 'point', title: 'Point', className: 'text-center' },
            { data: 'jumlah_tiket', title: 'Jumlah Tiket', className: 'text-center' },
            { data: 'sisa_tiket', title: 'Sisa Tiket', className: 'text-center' },
            { data: 'total_redeem', title: 'Total Redeem', className: 'text-center' },
            { data: 'pos_label', title: 'Pos' },
            moneyColumn('item_value', 'Value Out'),
        ],
        redeem_member: [
            { data: 'DT_RowIndex', title: '#', orderable: false },
            { data: 'tanggal', title: 'Tanggal' },
